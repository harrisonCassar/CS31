...
//#include <iostream> //compilation error: not including iostream in the form of '#include <iostream>'
using namespace std;   // pp. 38-39 in Savitch 6/e explains this line

int main()
{
	int numberSurveyed //compilation error: forgetting a semicolon
	int forNewsom;
	//int forCox; //compilation error: not declaring a variable that is in use by the function (in this case, 'main')

...
int main()
{
	...
	double pctNewsom = 100.0 * numberSurveyed / forNewsom; //logic error introduced on lines 20-21
	double pctCox = 100.0 * numberSurveyed / forCox; //switched around numberSurveyed with forNewsom and forCox, respectively
